...
class ProductPlan:
    ...
    @property
    def asynchronous(self) -> tuple[OperationPlan, ...]:
        """Les opérations qui répondent par un objet `operation` à surveiller."""
        return tuple(plan for plan in self.operations if plan.operation.is_async)
