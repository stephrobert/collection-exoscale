...
DOCUMENTATION = r"""
module: gadget_password_info
short_description: Gather information about Exoscale gadget passwords
version_added: 9.9.9
description:
- Read one Exoscale gadget password. This module never changes anything.
author:
...
- name: Read one gadget password
  lab.gadget.gadget_password_info:
    zone: ch-gva-2
...
RETURN = r"""
gadget_password:
  description: The gadget password.
  returned: always
  type: dict
"""
