...
# Opérations : reveal-dbaas-clickhouse-user-password
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_clickhouse_password_info
short_description: Gather information about Exoscale dbaas clickhouse passwords
version_added: 0.1.0
description:
- Read one Exoscale dbaas clickhouse password. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one dbaas clickhouse password
  stephrobert.exoscale.dbaas_clickhouse_password_info:
    zone: ch-gva-2
...
RETURN = r"""
dbaas_clickhouse_password:
  description: The dbaas clickhouse password.
  returned: always
  type: dict
"""
...
MODULE = InfoModule(
    ...
    get_operation=Operation(
        id="reveal-dbaas-clickhouse-user-password",
        method="reveal_dbaas_clickhouse_user_password",
