...
# Opérations : get-operation
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: general_operation_info
short_description: Gather information about Exoscale operations
version_added: 0.1.0
description:
- Read one Exoscale operation. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one operation
  stephrobert.exoscale.general_operation_info:
    zone: ch-gva-2
