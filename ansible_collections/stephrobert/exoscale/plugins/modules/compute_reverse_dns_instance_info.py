...
# Opérations : get-reverse-dns-instance
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: compute_reverse_dns_instance_info
...
EXAMPLES = r"""
- name: Read one reverse dns instance
  stephrobert.exoscale.compute_reverse_dns_instance_info:
    zone: ch-gva-2
