...
# Opérations : reveal-dbaas-opensearch-user-password
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_opensearch_password_info
short_description: Gather information about Exoscale dbaas opensearch passwords
version_added: 0.1.0
description:
- Read one Exoscale dbaas opensearch password. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one dbaas opensearch password
  stephrobert.exoscale.dbaas_opensearch_password_info:
    zone: ch-gva-2
...
RETURN = r"""
dbaas_opensearch_password:
  description: The dbaas opensearch password.
  returned: always
  type: dict
"""
...
MODULE = InfoModule(
    ...
    get_operation=Operation(
        id="reveal-dbaas-opensearch-user-password",
        method="reveal_dbaas_opensearch_user_password",
