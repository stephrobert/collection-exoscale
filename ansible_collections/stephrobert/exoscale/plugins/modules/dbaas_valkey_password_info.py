...
# Opérations : reveal-dbaas-valkey-user-password
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_valkey_password_info
short_description: Gather information about Exoscale dbaas valkey passwords
version_added: 0.1.0
description:
- Read one Exoscale dbaas valkey password. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one dbaas valkey password
  stephrobert.exoscale.dbaas_valkey_password_info:
    zone: ch-gva-2
...
RETURN = r"""
dbaas_valkey_password:
  description: The dbaas valkey password.
  returned: always
  type: dict
"""
...
MODULE = InfoModule(
    ...
    get_operation=Operation(
        id="reveal-dbaas-valkey-user-password",
        method="reveal_dbaas_valkey_user_password",
