...
# Opérations : reveal-dbaas-mysql-user-password
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_mysql_password_info
short_description: Gather information about Exoscale dbaas mysql passwords
version_added: 0.1.0
description:
- Read one Exoscale dbaas mysql password. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one dbaas mysql password
  stephrobert.exoscale.dbaas_mysql_password_info:
    zone: ch-gva-2
...
dbaas_mysql_password:
  description: The dbaas mysql password.
  returned: always
  type: dict
"""
...
MODULE = InfoModule(
    ...
    get_operation=Operation(
        id="reveal-dbaas-mysql-user-password",
        method="reveal_dbaas_mysql_user_password",
