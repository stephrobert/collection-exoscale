...
# Opérations : reveal-dbaas-thanos-user-password
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_thanos_password_info
short_description: Gather information about Exoscale dbaas thanos passwords
version_added: 0.1.0
description:
- Read one Exoscale dbaas thanos password. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one dbaas thanos password
  stephrobert.exoscale.dbaas_thanos_password_info:
    zone: ch-gva-2
...
RETURN = r"""
dbaas_thanos_password:
  description: The dbaas thanos password.
  returned: always
  type: dict
"""
...
MODULE = InfoModule(
    resource="dbaas_thanos_password",
    get_operation=Operation(
        id="reveal-dbaas-thanos-user-password",
        method="reveal_dbaas_thanos_user_password",
