...
# Opérations : get-dbaas-service-kafka
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_kafka_info
short_description: Gather information about Exoscale dbaas kafkas
version_added: 0.1.0
description:
- Read one Exoscale dbaas kafka. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one dbaas kafka
  stephrobert.exoscale.dbaas_kafka_info:
    zone: ch-gva-2
...
MODULE = InfoModule(
    resource="dbaas_kafka",
    get_operation=Operation(
        id="get-dbaas-service-kafka",
        method="get_dbaas_service_kafka",
