...
# Opérations : reveal-dbaas-grafana-user-password
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_grafana_password_info
short_description: Gather information about Exoscale dbaas grafana passwords
version_added: 0.1.0
description:
- Read one Exoscale dbaas grafana password. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one dbaas grafana password
  stephrobert.exoscale.dbaas_grafana_password_info:
    zone: ch-gva-2
...
RETURN = r"""
dbaas_grafana_password:
  description: The dbaas grafana password.
  returned: always
  type: dict
"""
...
MODULE = InfoModule(
    ...
    get_operation=Operation(
        id="reveal-dbaas-grafana-user-password",
        method="reveal_dbaas_grafana_user_password",
