...
# Opérations : get-deployment, list-deployments
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: ai_deployment_info
short_description: Gather information about Exoscale ai deployments
version_added: 0.1.0
description:
- Read one Exoscale ai deployment by its identifier, or list them. This module never changes
  anything.
author:
...
EXAMPLES = r"""
- name: List ai deployments
  stephrobert.exoscale.ai_deployment_info:
    zone: ch-gva-2
  register: result
- name: Read one ai deployment
  stephrobert.exoscale.ai_deployment_info:
    zone: ch-gva-2
...
RETURN = r"""
ai_deployment:
  description: The ai deployment, when a selector is given.
  returned: when the selector is given
  type: dict
ai_deployments:
  description: The ai deployments.
