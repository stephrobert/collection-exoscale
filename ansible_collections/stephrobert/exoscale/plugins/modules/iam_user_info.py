...
short_description: Gather information about Exoscale users
version_added: 0.1.0
description:
- List Exoscale users. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: List users
  stephrobert.exoscale.iam_user_info:
    zone: ch-gva-2
  register: result
"""
