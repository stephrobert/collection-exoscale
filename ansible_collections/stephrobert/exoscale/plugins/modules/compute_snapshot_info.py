...
# Opérations : get-snapshot, list-snapshots
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: compute_snapshot_info
short_description: Gather information about Exoscale snapshots
version_added: 0.1.0
description:
- Read one Exoscale snapshot by its identifier, or list them. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: List snapshots
  stephrobert.exoscale.compute_snapshot_info:
    zone: ch-gva-2
  register: result
- name: Read one snapshot
  stephrobert.exoscale.compute_snapshot_info:
    zone: ch-gva-2
...
RETURN = r"""
snapshot:
  description: The snapshot, when a selector is given.
