...
# Opérations : get-security-group, list-security-groups
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: compute_security_group_info
short_description: Gather information about Exoscale security groups
version_added: 0.1.0
description:
- Read one Exoscale security group by its identifier, or list them. This module never changes
  anything.
author:
...
- name: List security groups
  stephrobert.exoscale.compute_security_group_info:
    zone: ch-gva-2
  register: result
- name: Read one security group
  stephrobert.exoscale.compute_security_group_info:
    zone: ch-gva-2
...
RETURN = r"""
security_group:
  description: The security group, when a selector is given.
