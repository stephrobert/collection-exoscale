...
# Opérations : get-instance-type, list-instance-types
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: compute_instance_type_info
short_description: Gather information about Exoscale instance types
version_added: 0.1.0
description:
- Read one Exoscale instance type by its identifier, or list them. This module never changes
  anything.
author:
...
- name: List instance types
  stephrobert.exoscale.compute_instance_type_info:
    zone: ch-gva-2
  register: result
- name: Read one instance type
  stephrobert.exoscale.compute_instance_type_info:
    zone: ch-gva-2
...
RETURN = r"""
instance_type:
  description: The instance type, when a selector is given.
