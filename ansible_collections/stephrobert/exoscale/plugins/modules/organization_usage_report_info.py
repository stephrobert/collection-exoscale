...
DOCUMENTATION = r"""
module: organization_usage_report_info
short_description: Gather information about Exoscale usage reports
version_added: 0.1.0
description:
- List Exoscale usage reports. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: List usage reports
  stephrobert.exoscale.organization_usage_report_info:
    zone: ch-gva-2
  register: result
"""
