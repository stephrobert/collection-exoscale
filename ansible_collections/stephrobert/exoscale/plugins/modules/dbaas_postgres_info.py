...
# Opérations : get-dbaas-service-pg
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_postgres_info
short_description: Gather information about Exoscale dbaas postgres
version_added: 0.1.0
description:
- Read one Exoscale dbaas postgres. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: Read one dbaas postgres
  stephrobert.exoscale.dbaas_postgres_info:
    zone: ch-gva-2
...
RETURN = r"""
dbaas_postgres:
  description: The dbaas postgres.
  returned: always
  type: dict
"""
...
MODULE = InfoModule(
    resource="dbaas_postgres",
    get_operation=Operation(
        id="get-dbaas-service-pg",
        method="get_dbaas_service_pg",
