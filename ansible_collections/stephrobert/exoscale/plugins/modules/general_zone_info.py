...
# Opérations : list-zones
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: general_zone_info
short_description: Gather information about Exoscale zones
version_added: 0.1.0
description:
- List Exoscale zones. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: List zones
  stephrobert.exoscale.general_zone_info:
    zone: ch-gva-2
  register: result
"""
