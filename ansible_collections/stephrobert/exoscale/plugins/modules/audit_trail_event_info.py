...
# Opérations : list-events
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: audit_trail_event_info
short_description: Gather information about Exoscale events
version_added: 0.1.0
description:
- List Exoscale events. This module never changes anything.
author:
...
EXAMPLES = r"""
- name: List events
  stephrobert.exoscale.audit_trail_event_info:
    zone: ch-gva-2
  register: result
"""
