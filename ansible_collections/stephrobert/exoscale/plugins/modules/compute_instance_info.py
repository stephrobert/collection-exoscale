...
# Opérations : get-instance, list-instances
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: compute_instance_info
short_description: Gather information about Exoscale instances
version_added: 0.1.0
description:
- Read one Exoscale instance by its identifier, or list them. This module never changes anything.
author:
...
RETURN = r"""
instance:
  description: The instance, when a selector is given.
