...
# Opérations : get-dbaas-service-mysql
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: dbaas_mysql_info
short_description: Gather information about Exoscale dbaas mysqls
version_added: 0.1.0
description:
- Read one Exoscale dbaas mysql. This module never changes anything.
author:
...
MODULE = InfoModule(
    resource="dbaas_mysql",
    get_operation=Operation(
        id="get-dbaas-service-mysql",
        method="get_dbaas_service_mysql",
