...
# Opérations : list-routes
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: compute_vpc_subnet_route_info
...
EXAMPLES = r"""
- name: List vpc subnet routes
  stephrobert.exoscale.compute_vpc_subnet_route_info:
    zone: ch-gva-2
  register: result
"""
...
MODULE = InfoModule(
    resource="vpc_subnet_route",
    list_operation=Operation(
        id="list-routes",
        method="list_routes",
        path_params={"vpc_id": "vpc-id", "subnet_id": "subnet-id"},
